...
<body class="bg-gray-100 h-screen m-0 flex flex-col">
        <nav class="bg-white border-gray-200 dark:bg-gray-900 w-full">
          <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="uploads/GDPB.png" class="h-8" alt="Flowbite Logo" />
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
              <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                  <a href="http://photoboothpr.test/photoboothpr/photoboothpr/showqr" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">ShowQR</a>
                </li>
                <li>
                  <a href="http://photoboothpr.test/photoboothpr/photoboothpr/form" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Form</a>
                </li>
                <li>
...
?>
    ...
    <div class="container px-6 py-12 mx-auto">
        ...
        <div class="flex items-center justify-between">
            <a href="https://www.instagram.com/danielwidhi_198" target="_blank">
                <img class="w-auto h-7" src="uploads/Logo1.png" alt="GDPARTSTUDIO"> <!-- Increased logo size -->
            </a>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#reloadButton').on('click', function() {
				...
				$('#qr-container').html('<img src="uploads/Logo1b.png" alt="GDPARTSTUDIO" class="mx-auto mb-4 w-48 h-48"><h1 class="text-2xl font-semibold mb-4">Select your name to get your photo</h1>');
            });
        });
